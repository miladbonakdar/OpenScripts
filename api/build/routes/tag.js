...
router.route('/').post(passportAuthonticator_1.default, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                tag = new tag_1.Tag(req.body);
                tag.color = colorGenerator_1.randomColor();
                return [4 /*yield*/, tag.save()];
            case 1:
                _a.sent();
                res.success(tag, exports.name + ' created successfuly');
                return [2 /*return*/];
        }
    });
}); });
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, tag_1.Tag.findById(c._id)];
            case 1:
                tag = _a.sent();
                if (!tag)
            ...
            case 2:
                _a.sent();
                res.success(tag, exports.name + ' updated successfuly');
                return [2 /*return*/];
        }
    });
}); });
router.route('/:id').delete(passportAuthonticator_1.default, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, tag_1.Tag.findByIdAndDelete(req.params.id)];
            case 1:
                tag = _a.sent();
                if (!tag)
                    return [2 /*return*/, res.notFound()];
...
router.route('/').get(function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var courses;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, tag_1.Tag.find({})];
            case 1:
                courses = _a.sent();
                res.success(courses);
                return [2 /*return*/];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, tag_1.Tag.findById(req.params.id)];
            case 1:
                tag = _a.sent();
                if (!tag)
                    return [2 /*return*/, res.notFound()];
...
router.route('/:pageSize/:pageNumber').get(passportAuthonticator_1.default, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                page = new Pagination_1.default(tag_1.Tag, req.params.pageNumber, req.params.pageSize);
...
exports.default = { router: router, routePrefix: '/tag' };
