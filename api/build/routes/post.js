...
router.route('/').post(passportAuthonticator_1.default, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                post = new post_1.Post(req.body);
                post.color = colorGenerator_1.randomColor();
                post.createdAt = new Date();
                return [4 /*yield*/, post.save()];
            case 1:
                _a.sent();
                res.success(post, exports.name + ' created successfuly');
                return [2 /*return*/];
        }
    });
}); });
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, post_1.Post.findById(c._id)];
            case 1:
                post = _a.sent();
                if (!post)
            ...
            case 2:
                ...
                //   post.color = c.color
                _a.sent();
                res.success(post, exports.name + ' updated successfuly');
                return [2 /*return*/];
        }
    });
}); });
router.route('/:id').delete(passportAuthonticator_1.default, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, post_1.Post.findByIdAndDelete(req.params.id)];
            case 1:
                post = _a.sent();
                if (!post)
                    return [2 /*return*/, res.notFound()];
...
router.route('/:pageSize/:pageNumber').get(passportAuthonticator_1.default, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                page = new Pagination_1.default(post_1.Post, req.params.pageNumber, req.params.pageSize);
...
exports.default = { router: router, routePrefix: '/post' };
