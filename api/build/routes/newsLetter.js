...
router.route('/').post(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                client = new newsLetter_1.NewsLetter(req.body);
                client.createdAt = new Date();
                return [4 /*yield*/, client.save()];
            case 1:
                _a.sent();
                res.success(client, exports.name + ' created successfuly');
                return [2 /*return*/];
        }
    });
}); });
router
    ...
    .delete(passportAuthonticator_1.default, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var client;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!req.params.email)
                    return [2 /*return*/, res.badRequest('email')];
                return [4 /*yield*/, newsLetter_1.NewsLetter.deleteOne({ email: req.params.email })];
            case 1:
                client = _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, newsLetter_1.NewsLetter.findByIdAndDelete(req.params.id)];
            case 1:
                client = _a.sent();
                if (!client)
                    return [2 /*return*/, res.notFound()];
...
router.route('/').get(passportAuthonticator_1.default, function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, newsLetter_1.NewsLetter.find({})];
            case 1:
                courses = _a.sent();
                res.success(courses);
                return [2 /*return*/];
...
router.route('/:pageSize/:pageNumber').get(passportAuthonticator_1.default, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                page = new Pagination_1.default(newsLetter_1.NewsLetter, req.params.pageNumber, req.params.pageSize);
...
exports.default = { router: router, routePrefix: '/news-letter' };
